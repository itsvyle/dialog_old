...
//timezone: https://github.com/moment/moment-timezone/blob/develop/index.d.ts#L67
declare namespace moment {
    ...
    var timeFormat: "12h" | "24h";
    export function timeString(hours: number, minutes: number): string;
    export const TzUtcOffset: number; //added by me
}
